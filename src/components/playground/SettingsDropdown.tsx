...
import { CheckIcon, ChevronIcon, GearIcon } from "./icons";
...
export const SettingsDropdown = () => {
  ...
  return (
    <DropdownMenu.Root modal={false}>
      <DropdownMenu.Trigger className="group inline-flex max-h-12 items-center gap-1 rounded-md hover:bg-[#1c2536] bg-[#1c2536] border-gray-900 p-1 pr-2 text-gray-100">
